                 ...
                 def inError
                  try{
                    ...
                    sh """ 
                       ...
                       slackUploadFile filePath: '$WORKSPACE/server/mochawesome-report/*', initialComment: 'Unit test results for the current build | Job: ${env.JOB_NAME} | Build number ${env.BUILD_NUMBER}'
